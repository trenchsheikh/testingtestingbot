...
const TRANSLATIONS = {
  en: {
    ...
    markets_title: '📈 Available Markets (${count} pairs)\n\nSelect a market to view details:\n\nShowing: ${from}-${to} of ${count}',
    ...
    deposit_invalid_amount: 'Please provide a valid amount in USDT.\nUsage: `/deposit 50`',
    deposit_insufficient_usdt: '⚠️ **Insufficient USDT Balance!**\nYour wallet has ${balance} USDT, but you\'re trying to deposit ${amount} USDT.\n\nPlease send USDT to your wallet address first:\n\`${wallet}\`',
    deposit_low_gas: '⚠️ **Low Gas Balance!**\nYou need at least ~0.001 BNB in your wallet to pay for transaction fees.\n\nPlease send some BNB to your wallet address for gas fees.',
    deposit_tx_sent: '✅ **Deposit Transaction Sent!**\nYour funds should appear in your **Futures Account** in a few minutes.\n\n**Transaction Hash:** \`${hash}\`',
    deposit_failed_prefix: '❌ **Deposit Failed** ',
    balance_fetching: 'Hold on, fetching all your balances...',
    balance_header: '💰 Your Complete Balances:\n**Address:** \`${wallet}\`\n-----------------------------------\n**On-Chain Wallet:**\n  - \`${bnb} BNB\`\n  - \`${usdt} USDT\`\n**Spot Account:**\n',
    balance_spot_empty: '  - \`0.00 USDT\`\n',
    balance_futures: '-----------------------------------\n**Futures Account:**\n  - **Available:** \`${available} USDT\`\n  - **Total Margin:** \`${total} USDT\`',
    balance_unable_fetch: '❌ Unable to fetch your balances. Please try again in a moment.',
    transfer_usage: 'Usage: /transfer [amount] [asset]\nExample: /transfer 25 USDT',
    invalid_amount_number: 'Invalid amount. Please enter a valid number.',
    transfer_success_header: '✅ **Transfer Successful!**',
    transfer_failed_prefix: '❌ Transfer failed. ',
    markets_unable_fetch: '❌ Unable to fetch markets. Please try again in a moment.',
    positions_none: 'No open positions found.',
    positions_unable_fetch: '❌ Unable to fetch your positions. Please try again in a moment.',
    close_none: 'No open positions to close.',
    market_details_unable_fetch: '❌ Unable to fetch market details. Please try again.',
    enter_size_prompt: 'Selected: **${symbol}**\n\nEnter position size (in USDT):',
    invalid_deposit_amount: 'Invalid amount. Please enter a positive number for USDT deposit.',
  ...
  zh: {
    ...
    // Newly added keys for full localization
    deposit_invalid_amount: '请提供有效的 USDT 数量。\n用法：`/deposit 50`',
    deposit_insufficient_usdt: '⚠️ **USDT 余额不足！**\n您的钱包有 ${balance} USDT，但您尝试充值 ${amount} USDT。\n\n请先向您的钱包地址转入 USDT：\n\`${wallet}\`',
    deposit_low_gas: '⚠️ **BNB 燃料费不足！**\n您需要至少 ~0.001 BNB 用于支付交易费用。\n\n请先向您的钱包地址转入一些 BNB。',
    deposit_tx_sent: '✅ **充值交易已发送！**\n您的资金将在几分钟内出现在**合约账户**中。\n\n**交易哈希：** \`${hash}\`',
    deposit_failed_prefix: '❌ **充值失败** ',
    balance_fetching: '请稍候，正在获取您的全部余额…',
    balance_header: '💰 您的完整资产：\n**地址：** \`${wallet}\`\n-----------------------------------\n**链上钱包：**\n  - \`${bnb} BNB\`\n  - \`${usdt} USDT\`\n**现货账户：**\n',
    balance_spot_empty: '  - \`0.00 USDT\`\n',
    balance_futures: '-----------------------------------\n**合约账户：**\n  - **可用：** \`${available} USDT\`\n  - **总保证金：** \`${total} USDT\`',
    balance_unable_fetch: '❌ 无法获取您的余额，请稍后再试。',
    transfer_usage: '用法：/transfer [金额] [资产]\n示例：/transfer 25 USDT',
    invalid_amount_number: '无效金额。请输入有效数字。',
    transfer_success_header: '✅ **划转成功！**',
    transfer_failed_prefix: '❌ 划转失败。 ',
    markets_unable_fetch: '❌ 无法获取市场数据，请稍后再试。',
    positions_none: '暂无持仓。',
    positions_unable_fetch: '❌ 无法获取您的持仓，请稍后再试。',
    close_none: '没有可平的持仓。',
    market_details_unable_fetch: '❌ 无法获取市场详情，请重试。',
    enter_size_prompt: '已选择：**${symbol}**\n\n请输入仓位大小（USDT）：',
    invalid_deposit_amount: '无效金额。请填写正数的 USDT 充值数量。',
